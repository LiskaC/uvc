...
export const needs: Need[] = [
  {
    ...
    description:
      'Support a group of drone operators who need computers with high quality graphics cards! Donate money or your laptop.',
    links: [
      { text: 'Donate laptop', url: '/some-url' },
      { text: 'Donate cash', url: '/some-url' },
      { text: 'Group instagram', url: '/some-instagra,' },
    ],
  },
  {
    name: 'Medics',
    ...
    links: [
      { text: 'Donate bandages', url: '/some-url' },
      { text: 'Donate cash', url: '/some-url' },
    ],
  },
  {
    ...
    links: [
      { text: 'Contact us', url: routes.home.subroutes.contact.path },
      { text: 'Donate cash', url: '/some-url' },
    ],
  },
]
