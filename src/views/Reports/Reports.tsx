  ...
  return (
    <section>
      <div>
        ...
        <p>
          Our financial goal is to support the Ukrainian Armed Forces and cover organisational
          costs. Our guiding principles:
        </p>
        <ul>
          <li>
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            <b>Events:</b> Auctions and sales held during cultural gatherings and informative
            events.
          </li>
          <li>
            <b>In-kind contributions:</b> As our activists share our passion, a part of the funds
            have been in-kind contributions to support our cause.
          </li>
        </ul>
        <p>
        ...
        <p>
          <b>Want to get involved?</b> Whether you’d like to volunteer or support us in any other
          way —{' '}
          <a
      ...
      <div>
        ...
        <ul>
          <li>
            <b>Direct requests from the frontline:</b> We respond to needs shared with us directly
            by those on the frontline or volunteers. Every pound raised goes to causes we personally
            trust and verify.
          </li>
          <li>
      ...
      <div>
        ...
        <ol>
          ...
          <li>
            Delivered 10 requested packages to based on requests from the units working in the
            combat areas
          </li>
          <li>
            Organised and co-hosted multiple cultural events, including film screenings, Q&A
            sessions with Ukrainian soldiers, art exhibitions and music festivals.
          </li>
          <li>
