...
export const Home: FC = () => (
  <div>
    <p>
      We are a Scotland-based volunteer organisation of Ukrainians and friends of Ukraine, united in
      action for Ukrainian victory.
    </p>
    <p>
    ...
    <p>
      ...
      support to those on the frontlines and trusted grassroots initiatives in Ukraine, and build a
      strong, visible presence of solidarity through events, educational outreach, and creative
      activism.
    </p>
    <section>
      <h2>💙 What We Do</h2>
    ...
    <p>
      Whether you&apos;re looking to take action, support financially, or simply learn more — you’re
      in the right place.
    </p>
