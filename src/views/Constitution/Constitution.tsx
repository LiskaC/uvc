...
export const Constitution: FC = () => (
  <section>
    ...
    <p>
      ...
      dedicated to supporting Ukraine, raising awareness, and advocating for justice. To mark the
      first anniversary of our statute, we’re sharing an overview – the foundation of our mission.
    </p>
    ...
    <ul className={styles['constitution__list']}>
      ...
      <li>
        🔹 Supporting Ukrainian Victory: We do not only want to talk about the importance of
        supporting Ukraine but to have a direct impact where it matters the most. For that we are
        supporting the most IMPORTANT people in Ukraine - Ukrainian Defenders. We have set up a
        platform to effectively and transparently manage funds, with financial reports presented to
        members.
      </li>
      <li>
        📅 Looking Ahead: As we enter our second year, we remain committed to advocacy, education,
        and direct action.
      </li>
      <li>📢 Join us at our AGM! Stay tuned for details on how to get involved.</li>
      <li>
        🔗 Want to support our work? Follow, donate, and spread the word! Every voice matters.
      </li>
    </ul>
    <p>
